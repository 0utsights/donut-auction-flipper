...
type OrderObservation struct {
	...
	CompetitiveUnitRewardCents int64     `json:"competitive_unit_reward_cents"`
...
type Evidence struct {
	...
	BestCompetitiveUnitRewardCents    int64     `json:"best_competitive_unit_reward_cents"`
	...
	FocusedCompetitiveUnitRewardCents int64     `json:"focused_competitive_unit_reward_cents"`
...
type Candidate struct {
	...
	ObservedOrderUnitRewardCents int64     `json:"observed_order_unit_reward_cents"`
