...
<div class="numbers"><div class="number"><span class="muted">One bulk order</span><strong>{{moneyCents .OrderUnitRewardCents}} each</strong><span class="muted">up to {{.MaxOrderQuantity}} units / {{.ExecutableBatches}} stacks</span></div><div class="number"><span class="muted">Relist each exact batch</span><strong>{{.Quantity}}× for {{money .TargetListPrice}}</strong><span class="muted">{{money .ExpectedProceeds}} after fee</span></div><div class="number profit"><span class="muted">Profit per stack</span><strong>+{{money .ConservativeProfit}}</strong><span class="muted">{{pct .MarginBPS}} ROI</span></div><div class="number"><span class="muted">Priority</span><strong>{{money .PriorityScore}} / day</strong><span class="muted">one order per item · {{.AuctionVolume24h}} sales</span></div></div>
