...
<div id="live" data-version="{{.Version}}"><div class="status"><strong>{{.ReadyCount}} ready</strong> · {{.CoreCount}} core · {{.FillerCount}} filler · minimum +{{money .MinimumProfit}} per exit for the $10M reference balance · updated {{clock .GeneratedAt}} · live</div>
<main id="good-orders">
