...
final class DonutScreen extends Screen {
    ...
    DonutScreen(Screen parent, FlipFeedClient auctions, CandidateFeedClient candidates) {
        super(Text.literal("Donut market flipper")); this.parent = parent; this.auctions = auctions; this.candidates = candidates;
    }
    ...
    @Override protected void init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.literal("Close"), button -> close()).dimensions(left + 296, top + 300, 144, 20).build());
        renderedKey = feedKey();
    }
