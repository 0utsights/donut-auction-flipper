    ...
    @Test void decodesBoundedBackendFeed() {
        String json = """
                {"version":7,"status":"ready","flips":[{
                  "key":"auction-1","auction_id":"auction-1","item_id":"minecraft:diamond",
                  "item_name":"Diamond","quantity":1,"seller":"alex","price":500000,
                  "reference_value":900000,"profit":400000,"margin_bps":8000,"confidence_bps":7200,
                  "volume_24h":12,"expires_at":"2026-08-22T20:00:00Z","search_command":"/ah Diamond",
                  "model_version":"robust-v2","expected_sell_minutes":8
                }]}
                """;
        ...
        assertEquals("ah Diamond", FlipFeedClient.commandWithoutSlash(feed.flips().getFirst()));
    }
